    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setTimeout(() => {
                    setSubmitted(false);
                    if (!user) setFormData({ name: '', company: '', email: '', port: '', message: '' });
                    // If logged in, we only clear request-specific fields
                ...
                <div className="grid grid-cols-1 xl:grid-cols-12 gap-12">
                    ...
                    <div className="xl:col-span-8">
                        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden relative">
                            ...
                            {/* Login Suggestion */}
                            {!user && (
                                <div className="bg-blue-50/50 border-b border-blue-100 p-3 flex justify-between items-center px-8">
                                    <span className="text-sm text-blue-800 flex items-center gap-2">
                                        <Lock size={14} /> Want faster inquiries?
                                    </span>
                                    <button onClick={openLoginModal} className="text-xs font-bold uppercase text-blue-600 hover:text-blue-800">
                            ...
                            <div className="flex border-b border-gray-100">
                                {tabs.map((tab) => (
                                    <button
                                        ...
                                        className={`flex-1 py-6 flex items-center justify-center gap-3 transition-all relative ${activeTab === tab.id ? 'bg-white text-midnight-900' : 'bg-gray-50 text-gray-500 hover:bg-gray-100'
                                            }`}
                                    >
                                        ...
                                        >
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="relative">
                                                        <input
                                                            ...
                                                            readOnly={!!user?.name}
                                                            className={`w-full border-b-2 border-gray-200 py-3 focus:border-gold-500 outline-none transition-colors bg-transparent placeholder-gray-300 ${user?.name ? 'opacity-80' : ''}`}
                                                            placeholder="John Doe"
                                                        />
                                                        {user?.name && <Lock size={12} className="absolute right-0 top-1/2 -translate-y-1/2 text-green-500" />}
                                                    </div>
                                                </div>
                                                <div className="space-y-2">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={handleInputChange}
                                                        className="w-full border-b-2 border-gray-200 py-3 focus:border-gold-500 outline-none transition-colors bg-transparent placeholder-gray-300"
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="relative">
                                                        <input
                                                            ...
                                                            onChange={handleInputChange}
                                                            readOnly={!!user?.email}
                                                            className={`w-full border-b-2 border-gray-200 py-3 focus:border-gold-500 outline-none transition-colors bg-transparent placeholder-gray-300 ${user?.email ? 'opacity-80' : ''}`}
                                                            placeholder="john@company.com"
                                                        />
                                                        {user?.email && <Lock size={12} className="absolute right-0 top-1/2 -translate-y-1/2 text-green-500" />}
                                                    </div>
                                                </div>
                                                <div className="space-y-2">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <textarea
                                                    ...
                                                    onChange={handleInputChange}
                                                    className="w-full border-b-2 border-gray-200 py-3 focus:border-gold-500 outline-none transition-colors bg-transparent resize-none placeholder-gray-300"
