            ...
            <section className="py-20 bg-midnight-950">
                <div className="max-w-[1800px] mx-auto px-6">
                    <div className="flex justify-between items-end mb-12">
                        ...
                        <button aria-label="View Full Gallery" className="text-white/60 hover:text-white border-b border-gold-500 pb-1 text-sm uppercase tracking-widest">View Full Gallery</button>
                    </div>
