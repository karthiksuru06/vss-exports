      ...
      <div className="max-w-[1800px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="space-y-8">
            <Link to="/" className="inline-flex flex-col group w-fit">
                <div className="flex items-center gap-3 mb-2">
                    <Anchor className="text-gold-500 h-8 w-8" />
            ...
            <div className="flex space-x-4">
              {[Facebook, Linkedin, Instagram].map((Icon, i) => (
                <button key={i} onClick={preventDefault} className="w-10 h-10 rounded-full bg-white/5 hover:bg-gold-600 flex items-center justify-center transition-all duration-300">
          ...
          <div>
            ...
            <div className="flex border-b border-white/20 pb-2 focus-within:border-gold-500 transition-colors">
              <input
                type="email"
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-white/30 uppercase tracking-widest gap-4">
          ...
          <div className="flex gap-8">
              <button onClick={preventDefault} className="hover:text-white transition-colors">Privacy Policy</button>
              <button onClick={preventDefault} className="hover:text-white transition-colors">Terms of Trade</button>
          </div>
        </div>
      </div>
    </footer>
