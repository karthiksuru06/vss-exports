        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {DIVISIONS.map((division, idx) => (
            <motion.div
              ...
              className={`group relative overflow-hidden rounded-sm border-2 ${division.color} border-opacity-30 hover:border-opacity-100 transition-colors duration-500 flex flex-col h-[600px] shadow-lg hover:shadow-[0_0_30px_rgba(212,175,55,0.15)]`}
            >
              {/* Background Image */}
